...
if choice == "2":
    def displayPlot():
        plt.plot(problem2(), "r", label = "Problem 2")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "3":
    def displayPlot():
        plt.plot(problem3(), "b", label = "Problem 3")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "4":
    def displayPlot():
        plt.plot(problem4(), "m", label = "Problem 4")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "5":
    def displayPlot():
        plt.plot(problem5(), "y", label = "Problem 5")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "6":
    def displayPlot():
        plt.plot(problem6(), "g", label = "Problem 6")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "8":
    def displayPlot():
        plt.plot(problem8(), "r", label = "Problem 8")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "9":
    def displayPlot():
        plt.plot(problem9(), "y", label = "Problem 9")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
...
if choice == "10":
    def displayPlot():
        plt.plot(problem10(), "b", label = "Problem 10")
        plt.xlabel("Value of X")
        plt.ylabel("Answer")
        plt.show()
    displayPlot()
